package mil.pacom.logcop.jira.poc;
...
import mil.pacom.logcop.jira.poc.intg.mapper.SprintMapper;
import mil.pacom.logcop.jira.poc.intg.rest.CustomField;
import mil.pacom.logcop.jira.poc.intg.rest.Field;
	...
	private static List<Sprint> getSprints(Issue issue) {
		...
		try {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				if (obj != null) {
					Sprint sprint = SprintMapper.mapSprintObject(obj);
