...
public class SampleDocumentPOC {
	...
	public static void createContent(MainDocumentPart wordDocumentPart ) {
		...
		try {
			addObject(wordDocumentPart, WordXMLTemplate.HEADER );
	...
	// TODO: delete me, just using to test something...
	static void addObject(MainDocumentPart wordDocumentPart, String template ) throws JAXBException {
		
	    Object o = XmlUtils.unmarshallFromTemplate(template, new HashMap());
	    wordDocumentPart.addObject(o);    		    
	...
	final static String sampleTextItalic =	
	...
	final static String sampleTextBoldItalic =
			"<w:p xmlns:w=\"http://schemas.openxmlformats.org/wordprocessingml/2006/main\">" +
			  "<w:r>" +
			    "<w:rPr>" +
			      "<w:rFonts w:ascii=\"${fontname}\" w:eastAsia=\"${fontname}\" w:hAnsi=\"${fontname}\" w:cs=\"${fontname}\" />" +
