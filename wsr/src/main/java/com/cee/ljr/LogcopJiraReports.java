...
public class LogcopJiraReports {
	...
	public static void main(String[] args) {
		...
		String holidays = "0";
		String weekEndDate = "04/02/2017";
		String pathToReports = null;
		String pathToJiraCsvs = "C:/wsr_dev/JIRA1.csv;C:/wsr_dev/JIRA2.csv;C:/wsr_dev/JIRA3.csv;C:/wsr_dev/JIRA4.csv;C:/wsr_dev/JIRA5.csv";
